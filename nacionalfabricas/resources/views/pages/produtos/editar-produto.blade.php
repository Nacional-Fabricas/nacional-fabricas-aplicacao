        ...
        <div class="bloco-galeria">
            ...
            <div class="campos-formulario">
                ...
                <div class="bloco-galeria">
                    ...
                    <input class="adicionar-imagem" type="file" id="inputAdicionarImagem" accept="image/*">

                    <div class="modal fade" id="modalRecorteAdicionarImagem" tabindex="-1" aria-labelledby="modalRecorteAdicionarImagemLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="modalRecorteAdicionarImagemLabel">Recortar Imagem</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body" style="height: 60vh;">
                                    <div class="img-container" style="height: 100%;">
                                        <img id="imagemRecorteAdicionarImagem" class="img-fluid" alt="Recortar imagem">
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                                    <button type="button" id="salvarRecorteAdicionarImagem" class="btn btn-primary">Salvar</button>
                                </div>
                            </div>
                        </div>
                    </div>
