...
<div class="bloco-categoria">
    ...
    <form id="form-delete" action="{{route('excluir_categoria')}}" method="post" class="formulario" enctype="multipart/form-data">
        @csrf
        @method('DELETE')
    ...
    <div class="botoes">
        <button type="button" onclick="document.getElementById('form-update').submit();">Salvar categoria</button>
        <button type="button" onclick="document.getElementById('form-delete').submit();">Deletar</button>
    </div>
