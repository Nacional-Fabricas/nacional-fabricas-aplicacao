...
return [
    ...
    */
    ...
    | especificar uma mensagem de idioma específica para uma regra de atributo dada.
    |
    */
    ...
    | com algo mais fácil de ler, como "Endereço de E-mail" em vez de "email". Isso simplesmente nos ajuda a tornar nossa mensagem mais expressiva.
    |
    */
