<x-action-section>
    ...
    <x-slot name="content">
                    ...
                    <div class="sessoesLog">
                        ...
                        <div class="ms-3">
                            <div class="text-sm text-gray-600">
                                {{ $session->agent->platform() ? $session->agent->platform() : __('Desconhecido') }} - {{ $session->agent->browser() ? $session->agent->browser() : __('Unknown') }}
                            </div>
        ...
        <div class="flex items-center mt-5">
            <x-button class="logout" wire:click="confirmLogout" wire:loading.attr="disabled">
